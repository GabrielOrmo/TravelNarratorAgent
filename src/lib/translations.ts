...
type TranslationKeys = {
  ...
  scanWithCameraButton: string; // Updated to "Scan w/ Camera"
  ...
  initialNarrativeLabel: string; // New key
  startConversationPlaceholder: string; // New key
  audioNotSupported: string;
  audioUnavailableTitle: string;
  audioUnavailableDescription: string;
  narrativeTextLabel: string; // Might be less used now
  noNarrativeText: string;
  followUpQuestionLabel: string; // Might be less used now
  ...
  aiThinking: string;
  yourQuestionLabel: string; // Might be less used now
  aiAnswerLabel: string; // Might be less used now
